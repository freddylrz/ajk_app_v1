        ...
        <div id="detail-container" data-id="{{ $id }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-light border d-none" id="area-validasi-opr">
                        <h5 class="mb-3"><i class="ti ti-user-check"></i> Submit Ke SPV</h5>
                        <div class="form-group">
                            <label>Catatan</label>
                            <textarea class="form-control" id="catatan_validasi_opr" rows="2"
                    ...
                    <div class="alert alert-light border d-none" id="area-validasi-tib">
                        <h5 class="mb-3"><i class="ti ti-user-check"></i> Validasi TIB</h5>
                        <div class="form-group">
                            <label>Catatan</label>
                            <textarea class="form-control" id="catatan_validasi_tib" rows="2"
                                placeholder="Wajib diisi jika data dikembalikan ke Operator"></textarea>
                        </div>
                        <div class="d-flex justify-content-end gap-2 flex-wrap mt-2">
                            <button type="button" class="btn btn-warning" id="btn-kembalikan-tib">
                                <i class="ti ti-arrow-back-up"></i> Kembalikan ke Operator
                            </button>
                            <button type="button" class="btn btn-success" id="btn-setujui-tib">
                                <i class="ti ti-check"></i> Validasi
                            </button>
                        </div>
                    </div>
