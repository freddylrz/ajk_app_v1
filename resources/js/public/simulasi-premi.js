...
$(function () {
    ...
    /* ── Hitung simulasi premi (tanpa login): memanggil API premium-calculation ── */
    $('#btn-hitung').on('click', async function () {
        ...
        try {
            const res = await ClientHelper.apiFetch('/api/v1/public/declaration/premium-calculation', {
                method: 'POST',
            ...
            console.error('Gagal memanggil /public/declaration/premium-calculation:', err);
